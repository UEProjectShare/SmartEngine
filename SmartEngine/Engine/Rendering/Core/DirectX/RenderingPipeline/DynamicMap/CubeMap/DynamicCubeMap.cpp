...
{
	if (const FCubeMapRenderTarget* InRenderTarget = dynamic_cast<FCubeMapRenderTarget*>(RenderTarget.get()))
	{
...
void FDynamicCubeMap::SetViewportPosition(const fvector_3d& InCenterPoint) const
{
	//捕获摄像机四个面
