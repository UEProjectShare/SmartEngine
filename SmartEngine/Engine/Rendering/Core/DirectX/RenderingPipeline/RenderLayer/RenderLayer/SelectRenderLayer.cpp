...
void FSelectRenderLayer::BuildShader()
{
	...
	VertexShader.BuildShaders(L"../SmartEngine/Shader/SelectShadow.hlsl", "VertexShaderMain", "vs_5_1", D3DShaderMacro.data());
	PixelShader.BuildShaders(L"../SmartEngine/Shader/SelectShadow.hlsl", "PixelShaderMain", "ps_5_1", D3DShaderMacro.data());
